...
-- Email: admin@davaa.in
-- Password: admin123

-- First, check if admin user exists and delete if present
DELETE FROM users WHERE email = 'admin@davaa.in';
...
('admin@davaa.in', '$2a$10$rXKe/8z.j1QJE7pVYwZjKe5vYQXJKJ8GhPZvqJ5Z4NqY5cZNqK5bS', 'Admin User', '+919999999999', 'admin');
